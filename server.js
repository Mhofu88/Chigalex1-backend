...
// Required by Pi Developer Portal – Step 8
// Must be accessible at /validation-key.txt
// ════════════════════════════════════════════
...
<body>
  ...
  <p>By accessing and using Chigalex1 ("the App"), you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the App.</p>

  <h2>2. Description of Service</h2>
  <p><strong class="pi">Chigalex1</strong> is an educational DApp that provides step-by-step training on Pi Network registration, KYC, KYB, Map of Pi, and Pi security across all 54 African countries in 22 languages.</p>

  <h2>3. Membership Fee</h2>
  <p>Access to Chigalex1 training content requires a <strong>one-time membership fee of 1 Pi (1π)</strong>. This is an independent community app access fee and is <span class="warn">NOT a charge by Pi Network or SocialChain Inc.</span></p>
  ...
  <h2>6. Contact</h2>
  <p>Submit questions through the Ask the Administrator feature at <a href="/">chigalex1-backend.onrender.com</a></p>
...
EOF
echo "✅ server.js done — $(wc -l < /mnt/user-data/outputs/server.js) lines"